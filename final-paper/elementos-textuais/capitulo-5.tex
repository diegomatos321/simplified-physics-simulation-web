...
\begin{figure}[h]
	\centering
	\includesvg[width=0.8\linewidth]{fecho-convexo-interseccao}
	\caption{As figuras à esquerda não tem intersecção de seus volumes delimitadores, logo não podem estar em colisão. Já as figuras da direita estão se sobrepondo, logo \textbf{podem} estar em colisão.}
